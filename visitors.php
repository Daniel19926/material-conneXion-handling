          ...
          <div class="row tile_count">
				...
				<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
					<span class="count_top"></i> This month <?php echo "(".date("M").")"?></span>
						<div class="count"><?php foreach($pdo->query( 'CALL thismonth()' ) as $row){  echo $row['visitors'];}?></div>
							<span class="count_bottom">
				...
				<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
					...
					<div class="count"><?php foreach($pdo->query( 'call today();' ) as $row){ if (!empty($row['today'])){ echo $row['today'];}
							else {echo "0"; }} ?></div>
						<span class="count_bottom">
				...
				<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
					...
					<div class="count"><?php foreach($pdo->query( 'Select ROUND (AVG (visitors)) AS avg from visitor;' ) as $row){ echo $row['avg'];}?></div>
